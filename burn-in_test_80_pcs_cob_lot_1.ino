...
#if defined(ATL3304_COB)
#define current_avg         32.6     //set the 
#define current_vdd         64.54
#define GAIN_75k_set        1.274
#define GAIN_200k_set       1.039

#elif defined(ATL3304)
#define current_avg         34.6     //set the 
#define current_vdd         64.54
#define GAIN_75k_set        1.294
#define GAIN_200k_set       1.039

#elif defined(ATL3302)
#define current_avg         26.8
#define current_vdd         45.2
#define GAIN_75k_set        1.214
#define GAIN_200k_set       1.010

#elif defined(ATL3302_COB)
#define current_avg         24.8
#define current_vdd         44.8
#define GAIN_75k_set        1.214
#define GAIN_200k_set       1.010
...
#define GAIN_LOW  0.97 * GAIN  //set device ga    -5%
#define GAIN 1
#define GAIN_HI   1.03 * GAIN  //set device gain  +5%
//-----------------------------
#define GAIN_75k_LOW  0.98 * GAIN_75k_set  //set device ga    -5%
//#define GAIN_75k      1.15
#define GAIN_75k_HI   1.02 * GAIN_75k_set  //set device gain  +5%
//-----------------------------
#define GAIN_200k_LOW  0.98 * GAIN_200k_set  //set device ga    -5%
//#define GAIN_200k      1.15
#define GAIN_200k_HI   1.02 * GAIN_200k_set  //set device gain  +5%
...
#define current_mA_hi  current_avg * 1.05      //max  typ 16.8

// gain =2 VDD currnet 28.4mA and 18.4mA
// gain =2 VDDH currnet 50mA and 31.6mA
// gain =1.2 vddh
// gain =1.2
#define current_mA_low current_avg * 0.95    //min
#define current_vdd_hi  current_vdd * 1.05      //max  typ 16.8
...
void IP_info()
{
  ...
  display.println( "IP address:\ " );  display.println(WiFi.localIP() );
                   ...
                   String stringtwo  = String( 'A' + stringOne + VOUT + stringOne + gain_75k*10 + stringOne + VREF + stringOne + VINT  + stringOne + VOFFSET * 1000 + stringOne + busvoltage + stringOne + current_mA + stringOne + vddvoltage + stringOne + vddcurrent + stringOne
